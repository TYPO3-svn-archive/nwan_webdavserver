...
// assuming this ext is installed locally
if (!defined('PATH_site')) define('PATH_site', current(explode('typo3conf', dirname(__FILE__))));
...
//$CFG->debugfunction=array('T3ListDir','ServeRequest','http_status');
//$CFG->debugfunction=array('PROPFIND','T3FileMTime','ServeRequest','http_status');
$CFG->debugfunction=array('ServeRequest','T3ListDir','T3Authenticate');
//$CFG->debugfunction=array('T3ReplaceMountPointsByPath');
...
$CFG->text['file']		= t3lib_extMgm::extPath('meta_ftpd').'nanoftpd/users';		// CBY path to file which holds user data
$CFG->text['sep']		= ":";					// the character which separates the columns
$CFG->crypt			= "md5";				// password encryption method ("plain" or "md5")
$CFG->rootdir 			= t3lib_extMgm::extPath('meta_ftpd').'nanoftpd';		//CBY nanoFTPd root directory
...
//$CFG->listen_addr =$TYPO3_CONF_VARS['EXTCONF']['meta_ftpd']['listen_addr'];
//$CFG->listen_port 		= $TYPO3_CONF_VARS['EXTCONF']['meta_ftpd']['listen_port'];					// port where nanoFTPd should listen // CBY GET IT FROM T3
//$CFG->low_port			= $TYPO3_CONF_VARS['EXTCONF']['meta_ftpd']['low_port'];
//$CFG->high_port			= $TYPO3_CONF_VARS['EXTCONF']['meta_ftpd']['high_port'];
//$CFG->max_conn			= $TYPO3_CONF_VARS['EXTCONF']['meta_ftpd']['max_conn'];					// max number of connections allowed
//$CFG->max_conn_per_ip	= $TYPO3_CONF_VARS['EXTCONF']['meta_ftpd']['max_conn_per_ip'];					// max number of connections per ip allowed
...
require_once "class.tx_metaftpd_t3io.php";
